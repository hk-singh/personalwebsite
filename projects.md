...
![Eight phase algorithm control logic](assets/Eight_phase_flow_chart-1.png){width=50%} ![Eight phase control loop](assets/Eight_phase_controlloop-1.png){width=50%}
